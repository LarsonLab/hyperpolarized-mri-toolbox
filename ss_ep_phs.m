function [rf,g,isodelay] = ss_ep_phs(ang, z_thk, z_tb, z_d, f, a, d, fs, ptype, z_ftype, ...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% $Header: /home/adam/cvsroot/src/ss/ss_ep_phs.m,v 1.2 2013/08/15 03:34:50 adam Exp $
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	if (SS_SLR_FLAG == 1), 
        ...
        if SS_VERSE_B1
            ...
            % More accurate to do just reveres RF pulse
        ...
        %
        if bitget(nlobe,1) == 1, 
            isodelay = ((nlobe+1)/2 * length(gpos) + (nlobe-1)/2 * length(gneg)) ...
                * SS_TS;
        else
            isodelay = (nlobe/2 * length(gpos) + nlobe/2 * length(gneg)) ...
                * SS_TS;
        end
