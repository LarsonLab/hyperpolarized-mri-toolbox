...
for i = 1:13
    epi_kidney_reformat(:,:,i) = imresize(epi_kidney(13:21,7:28,i)',[40 12]);
end

data = ifftnc_time(epi_kidney_reformat,3);
data = data/max(data(:));
data = imnoise(data,'gaussian',0,0.000008);
% save('retrospective_EPI_kidney_kspace','data');
...
%         recon_cs = CSL1NlCg(recon_cs,param);
    ...
    LplusS = recon_cs; L=zeros(y(1),y(2),y(3)); S=zeros(y(1),y(2),y(3));
    toc
end
toc
%%
...
for i=1:y(3)
    vasculature_LplusS(1,i) = mean2(abs(LplusS(15:19,7:10,i)));
    vasculature_original(1,i) = mean2(abs(pa(15:19,7:10,i)));
    vasculature_dft(1,i) = mean2(abs(recon_dft(15:19,7:10,i)));
end
x = 1:y(3);
figure;
